...
<html lang="en">
    ...
    <head>
        ...
        <link href="<c:url value="/resources/css/colors/blue.css" />" rel="stylesheet">
    ...
    <body class="fix-header fix-sidebar card-no-border">
                    ...
                    <div class="navbar-header">
                        <a class="navbar-brand" href="index.html">
                            ...
                            <b>
                                ...
                                <!-- Dark Logo icon -->
                                <img src="<c:url value="/resources/assets/images/download1.png"/>" style="width:95%" alt="homepage" class="dark-logo" />
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                                    ...
                                    <div class="table-responsive m-t-40">
                                        <table class="table stylish-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="active">
                                                    <td><span class="round"><img src="/resources/assets/images/users/2.jpg" alt="user" width="50" /></span></td>
                                                    <td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <img class="card-img-top img-responsive" src="/resources/assets/images/big/img1.jpg" alt="Card">
                                <div class="card-block">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <img class="card-img-top img-responsive" src="/resources/assets/images/big/img2.jpg" alt="Card">
                                <div class="card-block">
                                    <ul class="list-inline font-14">
                                        <li class="p-l-0">20 May 2016</li>
                                        <li><a href="javascript:void(0)" class="link">3 Comment</a></li>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <img class="card-img-top img-responsive" src="/resources/assets/images/big/img4.jpg" alt="Card">
                                <div class="card-block">
                                    <ul class="list-inline font-14">
                                        <li class="p-l-0">20 May 2016</li>
                                        <li><a href="javascript:void(0)" class="link">3 Comment</a></li>
        ...
        <script src="<c:url value="/resources//assets/plugins/flot/jquery.flot.js" />"></script>
        <script src="<c:url value="/resources/assets/plugins/flot.tooltip/js/jquery.flot.tooltip.min.js" />"></script>
